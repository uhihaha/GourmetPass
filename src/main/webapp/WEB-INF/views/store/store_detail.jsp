...
<%-- [3] 통합 앱 컨테이너: 모든 비즈니스 로직의 데이터 소스 --%>
<div class="detail-wrapper" id="storeDetailApp"
    ...
    <div class="detail-header">
        ...
        <div class="store-meta-info">
            ...
            <%-- 실시간 카운트: JS가 숫자를 갱신할 때 레이블을 유지하도록 data- 속성 부여 --%>
...
<%-- 핵심 엔진: 링크 복사(#copyLinkBtn) 및 실시간 인원 표시 로직 포함 --%>
