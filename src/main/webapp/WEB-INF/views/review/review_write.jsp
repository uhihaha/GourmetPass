...
<div style="display: flow-root; width: 100%; min-height: calc(100vh - 160px);">

    <div style="width: 80%; max-width: 600px; margin: 40px auto; padding: 30px; border: 2px solid #333; border-radius: 15px; background: #fff; box-sizing: border-box;">
        ...
        <form action="${pageContext.request.contextPath}/review/write" method="post">
            ...
            <div style="margin-bottom: 25px;">
                ...
                <select name="rating" required style="width: 100%; padding: 12px; border: 1px solid #999; border-radius: 5px; font-size: 16px; box-sizing: border-box;">
            ...
            <div style="margin-bottom: 25px;">
                ...
                <textarea name="content" placeholder="<spring:message code='review.write.placeholder' text='맛, 서비스, 분위기는 어떠셨나요? 솔직한 후기를 남겨주세요.' />" required 
                          style="width: 100%; height: 200px; padding: 15px; border: 1px solid #999; border-radius: 5px; resize: none; line-height: 1.6; font-family: inherit; box-sizing: border-box;"></textarea>
            </div>

            <div style="display: flex; gap: 15px; margin-top: 30px;">
                <button type="button" onclick="history.back();" 
                        style="flex: 1; padding: 15px; background: #eee; border: 1px solid #ccc; border-radius: 8px; cursor: pointer; font-weight: bold; box-sizing: border-box;">
                    <spring:message code="common.btn.cancel" text="취소" />
                </button>
                <button type="submit" 
                        style="flex: 1; padding: 15px; background: #333; color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: bold; font-size: 16px; box-sizing: border-box;">
