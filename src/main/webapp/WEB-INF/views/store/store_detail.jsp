...
<div class="detail-wrapper" 
    ...
    <div id="booking-area" class="interaction-card" style="display:none;">
        ...
        <sec:authorize access="isAnonymous()">
            <div class="text-center" style="padding: 20px;">
                예약은 <a href="<c:url value='/member/login'/>" style="text-decoration: underline; font-weight: 900;">로그인</a> 후 이용 가능합니다.
            </div>
        </sec:authorize>
    </div>
    ...
    <div id="waiting-area" class="interaction-card" style="display:none;">
        ...
        <sec:authorize access="isAnonymous()">
            <div class="text-center" style="padding: 20px;">
                웨이팅은 <a href="<c:url value='/member/login'/>" style="text-decoration: underline; font-weight: 900;">로그인</a> 후 이용 가능합니다.
            </div>
        </sec:authorize>
    </div>

    <%-- 6. 지도 및 리뷰 섹션 --%>
    <div id="map" style="width:100%; height:350px; border:2px solid #333; border-radius:15px; margin-bottom:50px;"></div>

    <div class="review-summary-section">
        <div class="card-header">
            <h3 class="card-title">💬 최근 리뷰</h3>
            <a href="<c:url value='/store/reviews?store_id=${store.store_id}'/>" class="btn-wire" style="font-size:12px; padding:5px 10px;">전체보기 ❯</a>
        </div>
        <div class="review-grid" style="margin-top:20px;">
            <c:choose>
                    ...
                    <c:forEach var="rev" items="${reviewList}">
                        <div class="item-card" style="margin-bottom:15px; padding: 20px;">
                            <div style="display:flex; justify-content:space-between; margin-bottom:10px;">
                                <span style="font-weight:900;">${rev.user_nm}</span>
                ...
                <c:otherwise>
                    <div style="text-align: center; padding: 40px; color: #999; font-weight: 800;">작성된 리뷰가 없습니다.</div>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
