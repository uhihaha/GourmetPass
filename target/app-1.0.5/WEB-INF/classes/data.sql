...
-- Store 1: 강남 (한식)
INSERT INTO STORE (store_id, user_id, store_name, store_category, store_addr1, store_lat, store_lon, open_time, close_time, res_unit, store_img) 
VALUES (SEQ_STORE.NEXTVAL, 'owner01', '강남 수라상', '한식', '서울 강남구 테헤란로 1', 37.497952, 127.027619, '11:00', '21:00', 30, 'owner01_store_img_1.jpg');

-- Store 2: 분당 (일식) - user_id 수정된 좌표 반영
INSERT INTO STORE (store_id, user_id, store_name, store_category, store_addr1, store_lat, store_lon, open_time, close_time, res_unit, store_img) 
VALUES (SEQ_STORE.NEXTVAL, 'owner02', '동원동 스시', '일식', '경기 성남시 분당구 동원동 1', 37.352251, 127.082965, '11:30', '22:00', 60, 'owner02_store_img_2.jpg');

-- Store 3: 홍대 (라멘)
INSERT INTO STORE (store_id, user_id, store_name, store_category, store_addr1, store_lat, store_lon, open_time, close_time, res_unit, store_img) 
VALUES (SEQ_STORE.NEXTVAL, 'owner03', '홍대 멘야', '일식', '서울 마포구 양화로 160', 37.556886, 126.923761, '11:00', '21:00', 30, 'owner03_store_img_3.jpg');

-- Store 4: 성수 (카페)
INSERT INTO STORE (store_id, user_id, store_name, store_category, store_addr1, store_lat, store_lon, open_time, close_time, res_unit, store_img) 
VALUES (SEQ_STORE.NEXTVAL, 'owner04', '카페 성수', '카페', '서울 성동구 아차산로 100', 37.544569, 127.056044, '09:00', '23:00', 60, 'owner04_store_img_4.jpg');

-- Store 5: 이태원 (양식/파스타)
INSERT INTO STORE (store_id, user_id, store_name, store_category, store_addr1, store_lat, store_lon, open_time, close_time, res_unit, store_img) 
VALUES (SEQ_STORE.NEXTVAL, 'owner05', '이태원 비스트로', '양식', '서울 용산구 이태원로 170', 37.534887, 126.993425, '12:00', '22:00', 60, 'owner05_store_img_5.jpg');

-- Store 6: 종로 (중식)
INSERT INTO STORE (store_id, user_id, store_name, store_category, store_addr1, store_lat, store_lon, open_time, close_time, res_unit, store_img) 
VALUES (SEQ_STORE.NEXTVAL, 'owner06', '종로 만리장성', '중식', '서울 종로구 삼일대로 380', 37.569588, 126.985929, '10:30', '21:30', 30, 'owner06_store_img_6.jpg');

-- Store 7: 잠실 (분식)
INSERT INTO STORE (store_id, user_id, store_name, store_category, store_addr1, store_lat, store_lon, open_time, close_time, res_unit, store_img) 
VALUES (SEQ_STORE.NEXTVAL, 'owner07', '잠실 떡볶이', '기타', '서울 송파구 올림픽로 300', 37.513261, 127.100130, '11:00', '20:00', 30, 'owner07_store_img_7.jpg');

-- Store 8: 여의도 (아시안)
INSERT INTO STORE (store_id, user_id, store_name, store_category, store_addr1, store_lat, store_lon, open_time, close_time, res_unit, store_img) 
VALUES (SEQ_STORE.NEXTVAL, 'owner08', '여의도 쌀국수', '양식', '서울 영등포구 국제금융로 10', 37.525542, 126.924874, '10:00', '21:00', 30, 'owner08_store_img_8.jpg');

-- Store 9: 판교 (한식/고기)
INSERT INTO STORE (store_id, user_id, store_name, store_category, store_addr1, store_lat, store_lon, open_time, close_time, res_unit, store_img) 
VALUES (SEQ_STORE.NEXTVAL, 'owner09', '판교 갈비', '한식', '경기 성남시 분당구 판교역로 146', 37.394760, 127.111195, '16:00', '23:00', 60, 'owner09_store_img_9.jpg');

-- Store 10: 을지로 (술집)
INSERT INTO STORE (store_id, user_id, store_name, store_category, store_addr1, store_lat, store_lon, open_time, close_time, res_unit, store_img) 
VALUES (SEQ_STORE.NEXTVAL, 'owner10', '을지로 노가리', '기타', '서울 중구 을지로 100', 37.566085, 126.990886, '17:00', '02:00', 60, 'owner10_store_img_10.jpg');
