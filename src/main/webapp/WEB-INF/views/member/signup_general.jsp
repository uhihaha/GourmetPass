...
<div style="width: 80%; margin: 0 auto; text-align: center;">
    <h2 style="margin-top: 30px;">일반 회원가입</h2>
        ...
        <table class="info-table" style="width: 100%; text-align: left;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="coordStatus" class="msg-ok" style="margin-top: 5px;">주소를 검색하면 자동으로 위도/경도가 입력됩니다.</div>
                </td>
            </tr>
        </table>
        
        <div style="margin: 30px 0;">
            <input type="submit" value="가입하기" class="btn-success" style="padding: 10px 40px;">
            <input type="button" value="취소" onclick="location.href='${pageContext.request.contextPath}/'" class="btn-danger" style="padding: 10px 40px;">
        </div>
    </form>
</div>
