...
<div class="login-wrapper">
    ...
    <div class="btn-group">
        ...
        <a href="<c:url value='/member/signup/select'/>" class="btn-signup"><spring:message code="member.login.signup" text="회원가입" /></a>
    </div>
    </form>
    
    <div class="social-login">
        <div class="social-title"><spring:message code="member.login.social.title" text="간편 로그인" /></div>
        <div class="social-buttons">
            <a class="social-btn kakao" href="<c:url value='/member/oauth/kakao'/>"><spring:message code="member.login.social.kakao" text="카카오로 로그인" /></a>
            <a class="social-btn google" href="<c:url value='/member/oauth/google'/>"><spring:message code="member.login.social.google" text="구글로 로그인" /></a>
        </div>
    </div>

    <div style="margin-top: 25px; font-size: 13px; color: #999;">
        <a href="<c:url value='/member/find'/>" style="text-decoration: underline;"><spring:message code="member.login.forgot" text="아이디/비밀번호를 잊으셨나요?" /></a>
    </div>
</div>
